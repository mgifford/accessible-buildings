...
Archived URL: (Add Wayback Machine link at time of preservation)
License: Copyright Sensory Trust. This file is a structured summary and interpretation only.
...
Example:
A building may have an accessible toilet.
If the lift to reach it is broken, access fails.
If the accessible entrance is locked, access fails.
If staff do not know how to assist, access fails.
